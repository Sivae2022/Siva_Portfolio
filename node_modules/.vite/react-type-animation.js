  ...
  return i(this, void 0, void 0, function() {
    ...
    return u(this, function(S) {
      switch (S.label) {
        ...
        case 2:
          return v2.done ? [3, 5] : (b2 = v2.value, m2 = b2.opCode(e2) === "WRITING" ? r2 + r2 * (Math.random() - 0.5) : n2 + n2 * (Math.random() - 0.5), b2.op(e2), [4, p(m2)]);
        case 3:
          S.sent(), S.label = 4;
        case 4:
...
function y(e2, t2, r2) {
  var n2, o2;
  return r2 === void 0 && (r2 = 0), u(this, function(a2) {
    switch (a2.label) {
      case 0:
...
!function(e2, t2) {
  ...
  if (e2 && typeof document != "undefined") {
    ...
    o2.type = "text/css", r2 === "top" && n2.firstChild ? n2.insertBefore(o2, n2.firstChild) : n2.appendChild(o2), o2.styleSheet ? o2.styleSheet.cssText = e2 : o2.appendChild(document.createTextNode(e2));
  }
}(".index-module_type__E-SaG::after {\n  content: '|';\n  animation: index-module_cursor__PQg0P 1.1s infinite step-start;\n}\n\n@keyframes index-module_cursor__PQg0P {\n  50% {\n    opacity: 0;\n  }\n}\n");
var m = (0, import_react.memo)((0, import_react.forwardRef)(function(o2, a2) {
  var i2 = o2.sequence, u2 = o2.repeat, c2 = o2.className, d2 = o2.speed, p2 = d2 === void 0 ? 40 : d2, h2 = o2.deletionSpeed, y2 = o2.omitDeletionAnimation, v2 = y2 !== void 0 && y2, m2 = o2.preRenderFirstString, w = m2 !== void 0 && m2, g = o2.wrapper, x = g === void 0 ? "span" : g, S = o2.splitter, E = S === void 0 ? function(e2) {
    return s([], l(e2), false);
  } : S, _ = o2.cursor, k = _ === void 0 || _, O = o2.style, T = function(e2, t2) {
    var r2 = {};
    for (var n2 in e2)
  ...
  var j, I, G, D, M, R, q = P[0], F = P[1], B = function(e2, r2) {
    ...
    return (0, import_react.useEffect)(function() {
      e2 && (typeof e2 == "function" ? e2(o3.current) : e2.current = o3.current);
    }, [e2]), o3;
  }(a2), Q = b;
  j = c2 ? "".concat(k ? Q + " " : "").concat(c2) : k ? Q : "", I = (0, import_react.useRef)(function() {
    var e2, t2 = i2;
    u2 === 1 / 0 ? e2 = f : typeof u2 == "number" && (t2 = Array(1 + u2).fill(i2).flat());
